...
public class ActiveWriteActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activewrite);
        ...
        btncomplete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (editTitle.getText().toString().equals("")){
                    ...
                    database.execSQL("INSERT INTO Active(title , maintext) values('" + title + "' , '" + text + "')");
                    Toast.makeText(ActiveWriteActivity.this,"글쓰기 완료!", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(getApplicationContext(), ActiveListviewActivity.class);
