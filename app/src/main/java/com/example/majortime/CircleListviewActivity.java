...
public class CircleListviewActivity extends AppCompatActivity {
    Button btnSearch;
    static int haha=0;
    View dialogView;
    TextView signtext;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_circlelistview);
        ...
        cursor=db.rawQuery("select title from Circle",null);
        ttitle="";
            ...
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if ((event.getAction() == KeyEvent.ACTION_DOWN) && (keyCode == KeyEvent.KEYCODE_ENTER)) {
                    ...
                    if (a.equals("")) {
                        ...
                        SQLiteDatabase db;
                        Intent intent = new Intent(getApplicationContext(), CircleMaintextActivity.class);
                        startActivity(intent);
                        db = mHelper.getWritableDatabase();
                        Cursor cursor;
                        cursor = db.rawQuery("select textnum, title , maintext from Circle WHERE title='" + a + "' ",null);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent it = new Intent(CircleListviewActivity.this, CircleMaintextActivity.class);   // 인텐트 처리
                it.putExtra("list", list.get(position));
                startActivity(it);
                SQLiteDatabase db;
                db = mHelper.getWritableDatabase();
                Cursor cursor;
                cursor = db.rawQuery("select textnum, title , maintext from Circle WHERE title='" + ob + "' ", null);
                texttextnum="";
                texttitle="";
                textmaintext="";
...
//                        it.putExtra("list", list.get(position));
//                        startActivity(it);
                dialogView = (View)View.inflate(CircleListviewActivity.this,R.layout.dialog1,null);
                AlertDialog.Builder dlg = new AlertDialog.Builder(CircleListviewActivity.this);
                ...
                dlg.setPositiveButton("확인", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        SQLiteDatabase db;
                        db = mHelper.getWritableDatabase();
                        db.execSQL("DELETE FROM Circle WHERE title = '" + ob + "';");
        ...
        btnwrite.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (signtext.getText().toString().equals("관리자")) {
                    Intent intent = new Intent(CircleListviewActivity.this, CircleWriteActivity.class);
                    startActivity(intent);
                } else {
